// Address: 0x14001e250
// Ghidra name: FUN_14001e250
// ============ 0x14001e250 FUN_14001e250 (size=256) ============


undefined8 *

FUN_14001e250(longlong param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *puVar1 = b2PolygonAndCircleContact::vftable;
  ...
  if (*(int *)(*(longlong *)(param_1 + 0x18) + 8) != 2) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureA->GetType() == b2Shape::e_polygon",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2PolygonAndCircleContact.cpp",0x29);
  ...
  if (*(int *)(*(longlong *)(puVar1[0xd] + 0x18) + 8) != 0) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureB->GetType() == b2Shape::e_circle",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2PolygonAndCircleContact.cpp",0x2a);
