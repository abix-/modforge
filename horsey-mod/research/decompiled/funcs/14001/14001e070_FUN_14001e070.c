// Address: 0x14001e070
// Ghidra name: FUN_14001e070
// ============ 0x14001e070 FUN_14001e070 (size=290) ============


undefined8 *

FUN_14001e070(longlong param_1,undefined4 param_2,longlong param_3,undefined4 param_4,
...

{
  ...
  *puVar1 = b2ChainAndPolygonContact::vftable;
  ...
  if (*(int *)(*(longlong *)(param_1 + 0x18) + 8) != 3) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureA->GetType() == b2Shape::e_chain",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2ChainAndPolygonContact.cpp",0x2b);
  ...
  if (*(int *)(*(longlong *)(puVar1[0xd] + 0x18) + 8) != 2) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureB->GetType() == b2Shape::e_polygon",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2ChainAndPolygonContact.cpp",0x2c);
