// Address: 0x1402b6460
// Ghidra name: FUN_1402b6460
// ============ 0x1402b6460 FUN_1402b6460 (size=1175) ============


void FUN_1402b6460(longlong param_1)
    ...
    if (iVar20 != 0) {
      ...
      do {
        ...
        if (((uVar1 & 0x50) != 0) && (uVar15 < 0xff)) {
          ...
          uVar11 = (ushort)bVar7 * (short)uVar22 + 1;
...
LAB_1402b65a8:
            ...
            if (uVar14 == 0x10) {
              ...
              uVar17 = ((ushort)((uVar11 >> 8) + uVar11) >> 8) + uVar22;

              uVar11 = sVar9 * sVar5 + 1;

              uVar18 = ((ushort)((uVar11 >> 8) + uVar11) >> 8) + uVar21;

              uVar11 = sVar6 * sVar9 + 1;

              uVar12 = ((ushort)((uVar11 >> 8) + uVar11) >> 8) + uVar13;

              uVar11 = (ushort)bVar7 * sVar9 + 1;
            ...
            else if (uVar14 == 0x40) goto LAB_1402b65a8;
        ...
        *puVar19 = ((uVar8 << 8 | uVar17) << 8 | uVar18) << 8 | uVar12;
