// Address: 0x1402b55d0
// Ghidra name: FUN_1402b55d0
// ============ 0x1402b55d0 FUN_1402b55d0 (size=480) ============


void FUN_1402b55d0(longlong param_1)
...
LAB_1402b5680:
          ...
          else if (uVar10 == 0x40) goto LAB_1402b5680;
          ...
          if (uVar10 == 0x100) {
            ...
            uVar5 = (short)uVar7 * (short)uVar9 + 1;
            ...
            if (uVar10 != 0x200) goto LAB_1402b573f;

            uVar5 = (short)uVar9 * (short)uVar7 + 1;
          ...
          uVar5 = ((ushort)(uVar2 >> 0x10) & 0xff) * (short)uVar4 + 1;

          uVar4 = (uint)((ushort)((uVar5 >> 8) + uVar5) >> 8);
