// Address: 0x1402b34a0
// Ghidra name: FUN_1402b34a0
// ============ 0x1402b34a0 FUN_1402b34a0 (size=481) ============


void FUN_1402b34a0(longlong param_1)
...
LAB_1402b3550:
          ...
          else if (uVar10 == 0x40) goto LAB_1402b3550;
          ...
          if (uVar10 == 0x100) {
            ...
            if (uVar10 != 0x200) goto LAB_1402b3610;
          ...
          uVar5 = ((ushort)(uVar2 >> 0x10) & 0xff) * (short)uVar9 + 1;
