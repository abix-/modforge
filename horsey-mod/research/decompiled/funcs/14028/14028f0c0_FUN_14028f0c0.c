// Address: 0x14028f0c0
// Ghidra name: FUN_14028f0c0
// ============ 0x14028f0c0 FUN_14028f0c0 (size=437) ============


void FUN_14028f0c0(longlong param_1)
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if ((bVar8 & 0xf) != uVar1) {
              ...
              *puVar10 = *(undefined4 *)(lVar2 + (ulonglong)(bVar8 & 0xf) * 4);
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if (bVar8 >> 4 != uVar1) {
              ...
              *puVar10 = *(undefined4 *)(lVar2 + (ulonglong)(bVar8 >> 4) * 4);
