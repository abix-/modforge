// Address: 0x14028ef10
// Ghidra name: FUN_14028ef10
// ============ 0x14028ef10 FUN_14028ef10 (size=425) ============


void FUN_14028ef10(longlong param_1)
      ...
      do {
        ...
        if ((int)uVar7 < iVar9) {
          ...
          do {
            ...
            *puVar13 = *(undefined4 *)(lVar2 + (ulonglong)(uVar4 & 0xf) * 4);
      ...
      do {
        ...
        if ((int)uVar7 < iVar9) {
          ...
          do {
            ...
            *puVar13 = *(undefined4 *)(lVar2 + uVar5 * 4);
