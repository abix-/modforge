// Address: 0x1402cd188
// Ghidra name: FUN_1402cd188
// ============ 0x1402cd188 FUN_1402cd188 (size=365) ============
...
void FUN_1402cd188(int param_1,DWORD param_2,DWORD param_3)
...

{
  ...
  local_28 = DAT_1403e8b00 ^ (ulonglong)auStackY_608;
  ...
  FUN_1402f94c0(&local_598,0,0x98);

  FUN_1402f94c0(&local_4f8,0,0x4d0);
