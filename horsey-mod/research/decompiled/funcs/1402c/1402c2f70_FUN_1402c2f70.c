// Address: 0x1402c2f70
// Ghidra name: FUN_1402c2f70
// ============ 0x1402c2f70 FUN_1402c2f70 (size=550) ============


void FUN_1402c2f70(longlong param_1)
    ...
    if (iVar13 != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        do {
          ...
          *puVar15 = ((uVar14 << 8 | uVar7 >> 0x10 & 0xff) << 8 | uVar7 >> 8 & 0xff) << 8 |
        ...
        do {
          ...
          uVar8 = ((ushort)(uVar7 >> 0x10) & 0xff) * (ushort)bVar1 + 1;

          uVar9 = ((ushort)(uVar7 >> 8) & 0xff) * (ushort)bVar2 + 1;

          uVar10 = ((ushort)uVar7 & 0xff) * (ushort)bVar3 + 1;
