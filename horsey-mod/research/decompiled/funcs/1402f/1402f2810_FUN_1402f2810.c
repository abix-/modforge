// Address: 0x1402f2810
// Ghidra name: FUN_1402f2810
// ============ 0x1402f2810 FUN_1402f2810 (size=1532) ============
...
double FUN_1402f2810(undefined8 param_1,undefined8 param_2)
    ...
    if ((-0x39 < iVar11) || (-1 < (longlong)uVar24)) {
      ...
      if ((auVar41._0_8_ != INFINITY) || (uVar14 != 0x7ff0000000000000)) {
        ...
        if (auVar41._0_8_ <= DAT_14030d9a0) {
          ...
          auVar25 = vfnmadd231sd_fma(auVar17,auVar42,auVar19);
          ...
          auVar17 = vfmadd231sd_fma(auVar37,auVar33,auVar43);

          auVar38._0_8_ = auVar25._0_8_ / auVar17._0_8_;

          auVar38._8_8_ = auVar25._8_8_;
          ...
          auVar17 = vfnmadd213sd_fma(auVar20,auVar34,auVar2);

          auVar21._8_8_ = 0;

          auVar21._0_8_ = auVar17._0_8_ * auVar38._0_8_ * auVar38._0_8_;

          auVar44._8_8_ = 0;

          auVar44._0_8_ = auVar38._0_8_ + *(double *)(&DAT_1403929d0 + (ulonglong)uVar10 * 8);

          auVar17 = vfnmadd231sd_fma(auVar44,auVar38,auVar21);

          auVar41._0_8_ = auVar17._0_8_;
