// Address: 0x1402af720
// Ghidra name: FUN_1402af720
// ============ 0x1402af720 FUN_1402af720 (size=1388) ============


void FUN_1402af720(longlong param_1)
...
LAB_1402af945:
            ...
            if (uVar26 == 0x10) {
              ...
              uVar22 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar18;
            ...
            else if (uVar26 == 0x40) goto LAB_1402af945;
        ...
        *puVar23 = ((uVar12 << 8 | uVar15) << 8 | uVar21) << 8 | uVar22;
