// Address: 0x1402a8ae0
// Ghidra name: FUN_1402a8ae0
// ============ 0x1402a8ae0 FUN_1402a8ae0 (size=551) ============


void FUN_1402a8ae0(longlong param_1)
      ...
      if ((int)uVar14 != 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          do {
            ...
            *puVar8 = ((uVar13 >> 8 & 0xff) << 8 | uVar13 >> 0x10 & 0xff) << 8 | uVar13 >> 0x18;
          ...
          do {
            ...
            uVar12 = (ushort)(byte)((uint)uVar5 >> 0x18) * (ushort)bVar1 + 1;
