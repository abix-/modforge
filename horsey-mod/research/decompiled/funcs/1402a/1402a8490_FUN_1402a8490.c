// Address: 0x1402a8490
// Ghidra name: FUN_1402a8490
// ============ 0x1402a8490 FUN_1402a8490 (size=1193) ============


void FUN_1402a8490(longlong param_1)
...
LAB_1402a8630:
              ...
              sVar12 = 0xff - (uVar17 & 0xff);

              uVar17 = sVar3 * sVar12 + 1;

              uVar20 = ((ushort)((uVar17 >> 8) + uVar17) >> 8) + uVar13;

              uVar17 = sVar4 * sVar12 + 1;

              uVar19 = ((ushort)((uVar17 >> 8) + uVar17) >> 8) + uVar15;

              uVar17 = sVar5 * sVar12 + 1;

              uVar6 = ((ushort)((uVar17 >> 8) + uVar17) >> 8) + uVar14;
            ...
            else if (uVar16 == 0x40) goto LAB_1402a8630;

          }

          else if (uVar16 == 0x100) {

            uVar17 = sVar3 * (short)uVar13 + 1;

            uVar20 = (uint)((ushort)((uVar17 >> 8) + uVar17) >> 8);

            uVar17 = (short)uVar15 * sVar4 + 1;

            uVar19 = (uint)((ushort)((uVar17 >> 8) + uVar17) >> 8);

            uVar17 = (short)uVar14 * sVar5 + 1;

            uVar6 = (uint)((ushort)((uVar17 >> 8) + uVar17) >> 8);
            ...
            uVar11 = (short)uVar13 * sVar3 + 1;

            uVar17 = sVar12 * sVar3 + 1;
