...
- **grounded2-rpg**, the mod itself. Rust cdylib (`main.dll`) +
...
- A new console window titled "Grounded 2 - RPG System" pops up in the game
  process. It tails the live mod log.
- `<DLL_dir>\grounded2_rpg.log` mirrors that output (file lives next
