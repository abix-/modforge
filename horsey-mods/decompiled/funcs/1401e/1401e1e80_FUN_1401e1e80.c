// Address: 0x1401e1e80
// Ghidra name: FUN_1401e1e80
// ============ 0x1401e1e80 FUN_1401e1e80 (size=429) ============


int FUN_1401e1e80(longlong param_1)
  ...
  *(undefined4 *)(lVar1 + 0x1f8) = uVar3;
  ...
  if (plVar2 == (longlong *)0x0) {
    ...
    iVar4 = (**(code **)(*plVar2 + 0x68))
                      ...
                      (plVar2,0,local_res10[0],local_res8[0],0,*(undefined4 *)(lVar1 + 0x3c));
...

  {
    ...
    iVar4 = (**(code **)(**(longlong **)(lVar1 + 0x30) + 0x48))
                      ...
                      (*(longlong **)(lVar1 + 0x30),0,&DAT_14034b3e8,local_res18);
    ...
    if (iVar4 < 0) {
      ...
      iVar4 = (**(code **)(**(longlong **)(lVar1 + 0x20) + 0x48))
                        ...
                        (*(longlong **)(lVar1 + 0x20),local_res18[0],0,lVar1 + 0x48);
