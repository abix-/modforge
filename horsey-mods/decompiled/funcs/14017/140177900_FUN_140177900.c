// Address: 0x140177900
// Ghidra name: FUN_140177900
// ============ 0x140177900 FUN_140177900 (size=240) ============


ulonglong FUN_140177900(longlong param_1,longlong param_2,longlong param_3)
    ...
    if ((char)uVar1 != '\0') {
      ...
      if (*(code **)(param_1 + 0x50) == (code *)0x0) {
        ...
        return uVar1;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001401779db. Too many branches */

                    /* WARNING: Treating indirect jump as call */

      uVar1 = (**(code **)(param_1 + 0x50))(*(undefined8 *)(param_1 + 0x60),param_2,param_3);
