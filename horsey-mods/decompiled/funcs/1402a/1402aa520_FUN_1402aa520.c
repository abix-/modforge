// Address: 0x1402aa520
// Ghidra name: FUN_1402aa520
// ============ 0x1402aa520 FUN_1402aa520 (size=1234) ============


void FUN_1402aa520(longlong param_1)
...
LAB_1402aa70d:
          ...
          else if (uVar12 == 0x40) goto LAB_1402aa70d;

        }

        else if (uVar12 == 0x100) {

          uVar15 = sVar6 * (short)uVar11 + 1;
