// Address: 0x1402aecc0
// Ghidra name: FUN_1402aecc0
// ============ 0x1402aecc0 FUN_1402aecc0 (size=676) ============


void FUN_1402aecc0(longlong param_1)
        ...
        if ((uVar5 & 1) == 0) {
          ...
          do {
            ...
            if (uVar18 != 0) {
              ...
              uVar9 = (ushort)bVar3 * (short)uVar15 + 1;
            ...
            *puVar17 = ((uVar15 << 8 | uVar13 >> 8 & 0xff) << 8 | uVar13 >> 0x10 & 0xff) << 8 |
