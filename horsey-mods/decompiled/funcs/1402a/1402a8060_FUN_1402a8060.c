// Address: 0x1402a8060
// Ghidra name: FUN_1402a8060
// ============ 0x1402a8060 FUN_1402a8060 (size=1058) ============


void FUN_1402a8060(longlong param_1)
    ...
    if (iVar18 != 0) {
      ...
      do {
        ...
        if (((uVar1 & 0x50) != 0) && ((char)uVar3 != -1)) {
          ...
          uVar11 = (uint)((ushort)((uVar8 >> 8) + uVar8) >> 8);

          uVar8 = uVar9 * (short)uVar13 + 1;

          uVar13 = (uint)((ushort)((uVar8 >> 8) + uVar8) >> 8);

          uVar9 = uVar9 * (short)uVar12 + 1;
...
LAB_1402a819f:
            ...
            uVar17 = ((ushort)((uVar15 >> 8) + uVar15) >> 8) + uVar11;
            ...
            uVar7 = ((ushort)((uVar15 >> 8) + uVar15) >> 8) + uVar12;
          ...
          else if (uVar14 == 0x40) goto LAB_1402a819f;

        }

        else if (uVar14 == 0x100) {

          uVar15 = sVar4 * (short)uVar11 + 1;

          uVar17 = (uint)((ushort)((uVar15 >> 8) + uVar15) >> 8);

          uVar15 = (short)uVar13 * sVar5 + 1;

          uVar16 = (uint)((ushort)((uVar15 >> 8) + uVar15) >> 8);

          uVar15 = (short)uVar12 * sVar6 + 1;
