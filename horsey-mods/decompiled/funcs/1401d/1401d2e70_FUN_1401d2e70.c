// Address: 0x1401d2e70
// Ghidra name: FUN_1401d2e70
// ============ 0x1401d2e70 FUN_1401d2e70 (size=265) ============


int FUN_1401d2e70(longlong param_1,uint *param_2,uint param_3,longlong param_4,longlong param_5)
  ...
  if (0 < (int)param_3) {
    ...
    do {
      ...
      *(uint *)(param_1 + -4 + (longlong)param_2) =
           ...
           ((*(uint *)(param_4 + 0x14) & uVar1) >> (*(byte *)(param_4 + 0x1f) & 0x1f) & 0xf8) << 2 |

           (uVar3 & 0x3e0) << 0x10 | uVar3 & 0xfc1f;
