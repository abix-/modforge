// Address: 0x14028e4f0
// Ghidra name: FUN_14028e4f0
// ============ 0x14028e4f0 FUN_14028e4f0 (size=761) ============


void FUN_14028e4f0(longlong param_1)
...

{
  ...
  iVar4 = (*(int *)(param_1 + 0x1c) - (iVar6 + 1) / 2) + iVar6;
        ...
        if ((int)uVar5 < iVar6) {
          ...
          do {
            ...
            if ((bVar10 & 0xf) != uVar2) {
              ...
              *pbVar8 = *(byte *)((ulonglong)(bVar10 & 0xf) + lVar3);
        ...
        if ((int)uVar5 < iVar6) {
          ...
          do {
            ...
            if (bVar10 >> 4 != uVar2) {
              ...
              *pbVar8 = *(byte *)((ulonglong)(bVar10 >> 4) + lVar3);
