// Address: 0x1402828a0
// Ghidra name: FUN_1402828a0
// ============ 0x1402828a0 FUN_1402828a0 (size=229) ============


ulonglong FUN_1402828a0(longlong param_1)
...

{
  ...
  while (0 < iVar2) {
    ...
    if ((lVar3 != 0) && (local_48[0] == '\x01')) {

      FUN_140282ba0(lVar3,uVar1,local_48,iVar2);
