// Address: 0x14028e060
// Ghidra name: FUN_14028e060
// ============ 0x14028e060 FUN_14028e060 (size=437) ============


void FUN_14028e060(longlong param_1)
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if ((bVar8 & 3) != uVar1) {
              ...
              *puVar10 = *(undefined4 *)(lVar2 + (ulonglong)(bVar8 & 3) * 4);
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if (bVar8 >> 6 != uVar1) {
              ...
              *puVar10 = *(undefined4 *)(lVar2 + (ulonglong)(bVar8 >> 6) * 4);
