// Address: 0x140231930
// Ghidra name: FUN_140231930
// ============ 0x140231930 FUN_140231930 (size=1589) ============


void FUN_140231930(int param_1,int param_2,longlong param_3,longlong param_4,longlong param_5,
...

{
    ...
    do {
      ...
      if (param_1 != 1) {
        ...
        do {
          ...
          iVar7 = (int)*(short *)(&DAT_1403582b4 + lVar10 * 4) * (*pbVar9 - 0x80);
      ...
      if (iVar4 == param_1 + -1) {
        ...
        iVar8 = (int)*(short *)(&DAT_1403582ba + lVar10 * 4) * (*pbVar5 - 0x80);

        iVar4 = (int)*(short *)(&DAT_1403582b8 + lVar10 * 4) * (*pbVar9 - 0x80) +
  ...
  if (uVar2 == param_2 - 1U) {
    ...
    if (iVar4 == param_1 + -1) {
      ...
      iVar7 = ((uint)*pbVar9 - (uint)(byte)(&DAT_1403582b0)[lVar10 * 4]) *
