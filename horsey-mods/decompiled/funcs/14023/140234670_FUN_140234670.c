// Address: 0x140234670
// Ghidra name: FUN_140234670
// ============ 0x140234670 FUN_140234670 (size=1573) ============


void FUN_140234670(int param_1,int param_2,longlong param_3,longlong param_4,longlong param_5,
...

{
  ...
  if (param_2 != 1) {
    ...
    do {
      ...
      if (iVar4 == param_1 + -1) {
        ...
        iVar4 = (int)*(short *)(&DAT_1403582b4 + lVar10 * 4) * (*pbVar8 - 0x80);

        iVar3 = (int)*(short *)(&DAT_1403582ba + lVar10 * 4) * (*pbVar5 - 0x80);

        iVar9 = (int)*(short *)(&DAT_1403582b8 + lVar10 * 4) * (*pbVar8 - 0x80) +
  ...
  if (uVar2 == param_2 - 1U) {
    ...
    if (iVar4 == param_1 + -1) {
      ...
      iVar3 = ((uint)*pbVar8 - (uint)(byte)(&DAT_1403582b0)[lVar10 * 4]) *
