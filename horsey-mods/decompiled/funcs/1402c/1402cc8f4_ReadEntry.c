// Address: 0x1402cc8f4
// Ghidra name: ReadEntry
// ============ 0x1402cc8f4 ReadEntry (size=158) ============
...

{
  ...
  pbVar5 = *param_1 + -(longlong)(char)(&DAT_1403872c0)[uVar3];

  uVar3 = *(uint *)(pbVar5 + -4) >> ((&DAT_1403872d0)[uVar3] & 0x1f);
