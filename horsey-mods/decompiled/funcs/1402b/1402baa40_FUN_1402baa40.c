// Address: 0x1402baa40
// Ghidra name: FUN_1402baa40
// ============ 0x1402baa40 FUN_1402baa40 (size=598) ============


void FUN_1402baa40(longlong param_1)
      ...
      if ((int)uVar15 != 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          do {
            ...
            *puVar8 = ((uVar14 >> 0x10 & 0xff | uVar13 << 8) << 8 | uVar14 >> 8 & 0xff) << 8 |
          ...
          do {
            ...
            uVar12 = ((ushort)uVar5 & 0xff) * (ushort)bVar2 + 1;
