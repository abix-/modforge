// Address: 0x1402b2200
// Ghidra name: FUN_1402b2200
// ============ 0x1402b2200 FUN_1402b2200 (size=538) ============


void FUN_1402b2200(longlong param_1)
      ...
      if ((int)uVar14 != 0) {
        ...
        if ((uVar4 & 1) == 0) {
          ...
          do {
            ...
            *puVar8 = (uVar13 >> 8 & 0xff | (uVar13 & 0xff) << 8) << 8 | uVar13 >> 0x10 & 0xff;
          ...
          do {
            ...
            uVar12 = ((ushort)uVar5 & 0xff) * (ushort)bVar1 + 1;

            uVar10 = ((ushort)((uint)uVar5 >> 8) & 0xff) * (ushort)bVar2 + 1;

            uVar9 = ((ushort)((uint)uVar5 >> 0x10) & 0xff) * (ushort)bVar3 + 1;
