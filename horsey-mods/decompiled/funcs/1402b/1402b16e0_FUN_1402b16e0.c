// Address: 0x1402b16e0
// Ghidra name: FUN_1402b16e0
// ============ 0x1402b16e0 FUN_1402b16e0 (size=480) ============


void FUN_1402b16e0(longlong param_1)
    ...
    if (iVar9 != 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        do {
          ...
          *puVar7 = ((uVar6 & 0xff | uVar8 << 8) << 8 | uVar6 >> 8 & 0xff) << 8 |
        ...
        do {
          ...
          uVar10 = ((ushort)uVar6 & 0xff) * (ushort)bVar3 + 1;

          uVar11 = ((ushort)(uVar6 >> 8) & 0xff) * (ushort)bVar2 + 1;

          uVar12 = ((ushort)(uVar6 >> 0x10) & 0xff) * (ushort)bVar1 + 1;
