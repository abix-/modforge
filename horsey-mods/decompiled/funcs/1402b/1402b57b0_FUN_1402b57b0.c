// Address: 0x1402b57b0
// Ghidra name: FUN_1402b57b0
// ============ 0x1402b57b0 FUN_1402b57b0 (size=592) ============


void FUN_1402b57b0(longlong param_1)
...
LAB_1402b58c3:
            ...
            else if (uVar14 == 0x40) goto LAB_1402b58c3;
            ...
            if (uVar14 == 0x100) {
              ...
              uVar7 = (short)uVar10 * (short)uVar13 + 1;
              ...
              if (uVar14 != 0x200) goto LAB_1402b5985;

              uVar7 = (short)uVar13 * (short)uVar10 + 1;
            ...
            uVar7 = ((ushort)(uVar2 >> 0x10) & 0xff) * (short)uVar3 + 1;

            uVar3 = (uint)((ushort)((uVar7 >> 8) + uVar7) >> 8);
