// Address: 0x14021ad80
// Ghidra name: thunk_FUN_140288220
// ============ 0x14021ad80 thunk_FUN_140288220 (size=5) ============


ulonglong thunk_FUN_140288220(undefined4 *param_1,longlong param_2)
...

{
  ...
  uVar4 = (**(code **)(*plVar1 + 0x78))(plVar1,&uStack_458);
  ...
  while( true ) {
    ...
    iVar3 = FUN_1401a98e0(puVar2 + 7,auStack_454);
