# `FUN_140060a80` @ 0x140060a80

**Size**: 3713 bytes
**Role**: `fatigue_rest_prompt` (string-anchored)
**Domain**: `fatigue` - fatigue/tiredness mechanic
**Pattern**: `repeated_op` - Calls one function many times (vector init or batch op)
**Evidence**: calls FUN_1400d0c80 x13

**Strings referenced**:
- `'%s is already a Champion horse!'`
- `'That horse is too old to race'`
- `'Now go to the track to watch %s race'`
- `'Horse'`
- `'Hay, why not give %s a new name'`
- `'%s is a shure fire winner!'`
- `'%s is a sure fire winner!'`
- `'Your horse is hungry  Feed it fi'`
- `'Go home and rest your horse firs'`
- `'Not enough money'`
- `'Good luck'`
- `'The corral is inside the fence p'`
- `'Only one Champion entry at a tim'`
- `'Try again later'`
- `'There aren t enough winning hors'`
- `'Maybe watch some more races'`
- `'More monneeey'`
- `'Your horse needs to win 2 races'`
- `'Before it can enter the Champion'`

**Game callers** (1): [`FUN_140060a80`](140060a80_FUN_140060a80.md)

**Game callees** (16): [`FUN_140027900`](140027900_FUN_140027900.md), [`FUN_140027e30`](140027e30_FUN_140027e30.md), [`FUN_1400285e0`](1400285e0_FUN_1400285e0.md), [`FUN_140060a80`](140060a80_FUN_140060a80.md), [`FUN_1400b76a0`](1400b76a0_FUN_1400b76a0.md), [`FUN_1400b7730`](1400b7730_FUN_1400b7730.md), [`FUN_1400c7520`](1400c7520_FUN_1400c7520.md), [`FUN_1400cf970`](1400cf970_FUN_1400cf970.md), [`FUN_1400cf9a0`](1400cf9a0_FUN_1400cf9a0.md), [`FUN_1400cfa00`](1400cfa00_FUN_1400cfa00.md)
  ... +6 more
