// Address: 0x140149200
// Ghidra name: thunk_FUN_140184480
// ============ 0x140149200 thunk_FUN_140184480 (size=5) ============


void thunk_FUN_140184480(ulonglong param_1)
...

{
  ...
  if (pvVar2 == (HANDLE)0x0) {
    ...
    alStackX_10[0] = (lVar4 >> 6) - (lVar4 >> 0x3f);

    if (DAT_1403fcb30 != (code *)0x0) {

      in_stack_ffffffffffffffe0 = 0;

      iVar1 = (*DAT_1403fcb30)(pvVar2,alStackX_10,0,0,0,0,0);

      if (iVar1 != 0) goto LAB_140184512;

    }

    iVar1 = (*DAT_1403fcb40)(pvVar2,alStackX_10,0,0,0,in_stack_ffffffffffffffe0 & 0xffffffff00000000
