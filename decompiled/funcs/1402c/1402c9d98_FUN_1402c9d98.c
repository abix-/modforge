// Address: 0x1402c9d98
// Ghidra name: FUN_1402c9d98
// ============ 0x1402c9d98 FUN_1402c9d98 (size=494) ============


char FUN_1402c9d98(longlong param_1,longlong *param_2,longlong param_3,byte *param_4)
...

{
  ...
  if (lVar2 != 0) {
    ...
    if ((*(char *)(lVar2 + 0x10) != '\0') &&
       ...
       ((*(int *)(param_3 + 0xc) != 0 || (*(int *)(param_3 + 4) < 0)))) {
      ...
      if ((((*(byte *)(param_3 + 4) & 0x80) == 0) || ((*param_4 & 0x10) == 0)) ||
