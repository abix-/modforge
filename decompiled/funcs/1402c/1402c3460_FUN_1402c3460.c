// Address: 0x1402c3460
// Ghidra name: FUN_1402c3460
// ============ 0x1402c3460 FUN_1402c3460 (size=548) ============


void FUN_1402c3460(longlong param_1)
    ...
    if (iVar13 != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        do {
          ...
          *puVar15 = ((uVar14 << 8 | uVar7 >> 8 & 0xff) << 8 | uVar7 >> 0x10 & 0xff) << 8 |
        ...
        do {
          ...
          *puVar15 = ((ushort)((uVar9 >> 8) + uVar9) & 0xffffff00 | uVar14 << 0x10 |
