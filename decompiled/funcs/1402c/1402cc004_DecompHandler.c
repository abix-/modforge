// Address: 0x1402cc004
// Ghidra name: DecompHandler
// ============ 0x1402cc004 DecompHandler (size=392) ============
...

{
  ...
  *(HandlerMap4 **)(this + 8) = pHVar8;
  ...
  if (((byte)HVar1 & 1) != 0) {
    ...
    pHVar8 = pHVar8 + -(longlong)(char)(&DAT_1403872c0)[(byte)HVar2 & 0xf];

    *(uint *)(this + 0x1c) = *(uint *)(pHVar8 + -4) >> ((&DAT_1403872d0)[(byte)HVar2 & 0xf] & 0x1f);
  ...
  if (((byte)HVar1 & 4) != 0) {
    ...
    *(uint *)(this + 0x24) = *(uint *)(pHVar8 + -4) >> ((&DAT_1403872d0)[(byte)HVar2 & 0xf] & 0x1f);
  ...
  *(HandlerMap4 **)(this + 8) = pHVar9;
  ...
  if (((byte)HVar1 & 8) == 0) {
    ...
    if (bVar6 == 0x10) {
      ...
      bVar6 = (&DAT_1403872d0)[(byte)*pHVar9 & 0xf];

      uVar5 = *(uint *)(((longlong)pHVar9 - (longlong)(char)(&DAT_1403872c0)[(byte)*pHVar9 & 0xf]) +

                       -4);

      *(longlong *)(this + 8) =

           (longlong)pHVar9 - (longlong)(char)(&DAT_1403872c0)[(byte)*pHVar9 & 0xf];
    ...
    pHVar9 = pHVar9 + -(longlong)(char)(&DAT_1403872c0)[(byte)*pHVar9 & 0xf];
