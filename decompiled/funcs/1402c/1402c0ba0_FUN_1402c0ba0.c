// Address: 0x1402c0ba0
// Ghidra name: FUN_1402c0ba0
// ============ 0x1402c0ba0 FUN_1402c0ba0 (size=1285) ============


void FUN_1402c0ba0(longlong param_1)
    ...
    if (iVar22 != 0) {
      ...
      do {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          uVar17 = (ushort)bVar3 * (ushort)(byte)(uVar7 >> 0x18) + 1;
...
LAB_1402c0dce:
            ...
            uVar11 = ((ushort)((uVar17 >> 8) + uVar17) >> 8) + uVar13;
          ...
          else if (uVar14 == 0x40) goto LAB_1402c0dce;

        }

        else if (uVar14 == 0x100) {

          uVar17 = sVar8 * (short)uVar15 + 1;
