// Address: 0x14028c8d0
// Ghidra name: FUN_14028c8d0
// ============ 0x14028c8d0 FUN_14028c8d0 (size=438) ============


void FUN_14028c8d0(longlong param_1)
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if ((bVar8 & 1) != uVar1) {
              ...
              *puVar10 = *(undefined2 *)(lVar2 + (ulonglong)(bVar8 & 1) * 2);
        ...
        if ((int)uVar4 < iVar5) {
          ...
          do {
            ...
            if (bVar8 >> 7 != uVar1) {
              ...
              *puVar10 = *(undefined2 *)(lVar2 + (ulonglong)(bVar8 >> 7) * 2);
