// Address: 0x1401ef1b0
// Ghidra name: FUN_1401ef1b0
// ============ 0x1401ef1b0 FUN_1401ef1b0 (size=505) ============


void FUN_1401ef1b0(longlong param_1,longlong param_2,int *param_3,undefined8 param_4,
...

{
  ...
  *(undefined8 *)(lVar2 + 0x218) = 0;
  ...
  (**(code **)(lVar2 + 400))
            ...
            (uVar1,0,*param_3 / 2,param_3[1] / 2,(param_3[2] + 1) / 2,(param_3[3] + 1) / 2,puVar3[4]

             ,puVar3[5],param_6);

  (**(code **)(lVar2 + 0x120))(0xcf2,param_9);

  (**(code **)(lVar2 + 0x40))(uVar1,puVar3[0x18]);
  ...
  FUN_1401ebd90("glTexSubImage2D()",param_1,"SDL_render_gl.c",0x373);
