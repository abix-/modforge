// Address: 0x1401e9e20
// Ghidra name: FUN_1401e9e20
// ============ 0x1401e9e20 FUN_1401e9e20 (size=587) ============


void FUN_1401e9e20(longlong param_1,longlong param_2,int *param_3,float *param_4)
  ...
  *param_4 = (float)bVar10;
  ...
  if (iVar4 < 0x3231564f) {
    ...
    if (iVar4 == 0x3231564e) {
      ...
      if (iVar4 != 0x3132564e) goto LAB_1401e9f2e;
