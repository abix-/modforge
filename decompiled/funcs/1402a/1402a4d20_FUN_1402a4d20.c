// Address: 0x1402a4d20
// Ghidra name: FUN_1402a4d20
// ============ 0x1402a4d20 FUN_1402a4d20 (size=678) ============


void FUN_1402a4d20(longlong param_1)
        ...
        if ((uVar5 & 1) == 0) {
          ...
          do {
            ...
            if (uVar18 != 0) {
              ...
              uVar8 = (ushort)bVar3 * (short)uVar15 + 1;
            ...
            *puVar17 = ((uVar15 << 8 | uVar13 >> 0x18) << 8 | uVar13 >> 0x10 & 0xff) << 8 |
          ...
          do {
            ...
            if (uVar18 != 0) {
              ...
              uVar12 = (ushort)bVar3 * (short)uVar15 + 1;

              uVar15 = (uint)((ushort)((uVar12 >> 8) + uVar12) >> 8);

            }

            *puVar17 = ((ushort)((uVar8 >> 8) + uVar8) & 0xffffff00 | uVar15 << 0x10 |
