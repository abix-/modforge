// Address: 0x1402afc90
// Ghidra name: FUN_1402afc90
// ============ 0x1402afc90 FUN_1402afc90 (size=1483) ============


void FUN_1402afc90(longlong param_1)
...
LAB_1402afefc:
              ...
              if (uVar27 == 0x10) {
                ...
                uVar24 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar18;

                uVar19 = sVar13 * sVar7 + 1;

                uVar25 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar17;
              ...
              else if (uVar27 == 0x40) goto LAB_1402afefc;
          ...
          *puVar26 = ((uVar10 << 8 | uVar24) << 8 | uVar25) << 8 | uVar15;
