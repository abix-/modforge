// Address: 0x1402ae430
// Ghidra name: FUN_1402ae430
// ============ 0x1402ae430 FUN_1402ae430 (size=512) ============


void FUN_1402ae430(longlong param_1)
...
LAB_1402ae4ed:
          ...
          else if (uVar7 == 0x40) goto LAB_1402ae4ed;
          ...
          if (uVar7 == 0x100) {
            ...
            uVar5 = (short)uVar6 * (short)uVar8 + 1;
            ...
            if (uVar7 != 0x200) goto LAB_1402ae5b8;
          ...
          uVar5 = ((ushort)(uVar2 >> 8) & 0xff) * (short)uVar9 + 1;

          uVar9 = (uint)((ushort)((uVar5 >> 8) + uVar5) >> 8);

          uVar5 = ((ushort)uVar2 & 0xff) * (short)uVar10 + 1;
...
LAB_1402ae5b8:
        ...
        *puVar12 = ((uVar4 << 8 | uVar8) << 8 | uVar9) << 8 | uVar10;
