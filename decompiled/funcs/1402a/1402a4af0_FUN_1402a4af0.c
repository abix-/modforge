// Address: 0x1402a4af0
// Ghidra name: FUN_1402a4af0
// ============ 0x1402a4af0 FUN_1402a4af0 (size=545) ============


void FUN_1402a4af0(longlong param_1)
      ...
      if ((uVar5 & 1) == 0) {
        ...
        do {
          ...
          if (uVar16 != 0) {
            ...
            uVar8 = (ushort)bVar4 * (short)uVar13 + 1;
          ...
          *puVar14 = ((uVar13 << 8 | uVar7 >> 0x18) << 8 | uVar7 >> 0x10 & 0xff) << 8 |
        ...
        do {
          ...
          uVar9 = ((ushort)(uVar7 >> 8) & 0xff) * (ushort)bVar1 + 1;

          uVar10 = ((ushort)(uVar7 >> 0x10) & 0xff) * (ushort)bVar2 + 1;

          uVar8 = (ushort)(byte)(uVar7 >> 0x18) * (ushort)bVar3 + 1;

          if (uVar16 != 0) {

            uVar11 = (ushort)bVar4 * (short)uVar13 + 1;
          ...
          *puVar14 = ((ushort)((uVar8 >> 8) + uVar8) & 0xffffff00 | uVar13 << 0x10 |
