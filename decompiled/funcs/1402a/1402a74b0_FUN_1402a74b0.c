// Address: 0x1402a74b0
// Ghidra name: FUN_1402a74b0
// ============ 0x1402a74b0 FUN_1402a74b0 (size=1296) ============


void FUN_1402a74b0(longlong param_1)
    ...
    if (iVar22 != 0) {
      ...
      do {
        ...
        if ((uVar5 & 2) != 0) {
          ...
          uVar17 = (ushort)bVar4 * (short)uVar13 + 1;
...
LAB_1402a76df:
            ...
            uVar11 = ((ushort)((uVar17 >> 8) + uVar17) >> 8) + uVar19;
          ...
          else if (uVar14 == 0x40) goto LAB_1402a76df;

        }

        else if (uVar14 == 0x100) {

          uVar17 = sVar8 * (short)uVar19 + 1;
