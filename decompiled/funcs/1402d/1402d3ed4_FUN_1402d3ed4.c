// Address: 0x1402d3ed4
// Ghidra name: FUN_1402d3ed4
// ============ 0x1402d3ed4 FUN_1402d3ed4 (size=142) ============


undefined1 FUN_1402d3ed4(longlong param_1,undefined4 *param_2)
...

{
  ...
  uVar3 = FUN_1402d20f0(lVar1,&local_18,10,1);
