// Address: 0x1402bca40
// Ghidra name: FUN_1402bca40
// ============ 0x1402bca40 FUN_1402bca40 (size=1061) ============


void FUN_1402bca40(longlong param_1)
...
LAB_1402bcb7f:
            ...
            uVar7 = ((ushort)((uVar11 >> 8) + uVar11) >> 8) + uVar13;
            ...
            uVar17 = ((ushort)((uVar11 >> 8) + uVar11) >> 8) + uVar12;
          ...
          else if (uVar15 == 0x40) goto LAB_1402bcb7f;
          ...
          uVar11 = (short)uVar12 * sVar6 + 1;

          uVar17 = (uint)((ushort)((uVar11 >> 8) + uVar11) >> 8);

        }

        else if (uVar15 == 0x200) {

          sVar10 = 0xff - (uVar11 & 0xff);

          uVar9 = sVar4 * (short)uVar13 + 1;
