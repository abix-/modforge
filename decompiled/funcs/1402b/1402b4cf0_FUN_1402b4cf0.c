// Address: 0x1402b4cf0
// Ghidra name: FUN_1402b4cf0
// ============ 0x1402b4cf0 FUN_1402b4cf0 (size=395) ============


void FUN_1402b4cf0(longlong param_1)
    ...
    if (iVar8 != 0) {
      ...
      if ((uVar5 & 1) == 0) {
        ...
        do {
          ...
          *puVar7 = ((uVar6 >> 0x10 & 0xff) << 8 | uVar6 >> 8 & 0xff) << 8 | uVar6 & 0xff;
        ...
        do {
          ...
          uVar11 = ((ushort)uVar6 & 0xff) * (ushort)bVar2 + 1;

          uVar9 = ((ushort)(uVar6 >> 0x10) & 0xff) * (ushort)bVar1 + 1;

          uVar10 = ((ushort)(uVar6 >> 8) & 0xff) * (ushort)bVar3 + 1;

          *puVar7 = ((ushort)((uVar9 >> 8) + uVar9) & 0xffffff00) << 8 |
