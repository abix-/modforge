// Address: 0x1402330d0
// Ghidra name: FUN_1402330d0
// ============ 0x1402330d0 FUN_1402330d0 (size=682) ============


void FUN_1402330d0(int param_1,uint param_2,longlong param_3,longlong param_4,longlong param_5,
    ...
    do {
      ...
      if (param_1 != 1) {
        ...
        do {
          ...
          iVar9 = (int)*(short *)(&DAT_1403582ba + lVar8 * 4) * (*pbVar10 - 0x80);

          iVar6 = (int)*(short *)(&DAT_1403582b4 + lVar8 * 4) * (*pbVar11 - 0x80);

          iVar4 = (int)*(short *)(&DAT_1403582b6 + lVar8 * 4) * (*pbVar10 - 0x80) +
      ...
      if (iVar2 == param_1 + -1) {
        ...
        iVar6 = ((uint)*pbVar5 - (uint)(byte)(&DAT_1403582b0)[lVar8 * 4]) *

                (int)*(short *)(&DAT_1403582b2 + lVar8 * 4);

        iVar2 = *pbVar10 - 0x80;

        bVar1 = FUN_140230cc0(*(short *)(&DAT_1403582b6 + lVar8 * 4) * iVar2 +

                              *(short *)(&DAT_1403582b8 + lVar8 * 4) * iVar4 + iVar6);

        uVar3 = (uint)bVar1;

        bVar1 = FUN_140230cc0(*(short *)(&DAT_1403582ba + lVar8 * 4) * iVar2 + iVar6);

        uVar3 = (uVar3 | (bVar1 | 0xffffff00) << 8) << 8;

        bVar1 = FUN_140230cc0(*(short *)(&DAT_1403582b4 + lVar8 * 4) * iVar4 + iVar6);
