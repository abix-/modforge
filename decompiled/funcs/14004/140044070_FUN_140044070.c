// Address: 0x140044070
// Ghidra name: FUN_140044070
// ============ 0x140044070 FUN_140044070 (size=192) ============


undefined8 FUN_140044070(undefined8 param_1,undefined8 param_2)
...

{
  ...
  if (_File != (FILE *)0x0) {
    ...
    if (_DstBuf != (void *)0x0) {
      ...
      uVar2 = FUN_140044140(_DstBuf,_ElementSize,param_2);
