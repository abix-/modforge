// Address: 0x1401db890
// Ghidra name: FUN_1401db890
// ============ 0x1401db890 FUN_1401db890 (size=239) ============


undefined8

FUN_1401db890(int param_1,int param_2,undefined1 (*param_3) [16],int param_4,
    ...
    do {
      ...
      if (3 < (int)uVar16) {
        ...
        do {
          ...
          auVar21 = pshuflw(auVar23,auVar23,0x93);

          auVar23 = pshufhw(in_XMM2,auVar21,0x93);

          auVar21 = pshuflw(auVar21,auVar22,0x93);

          auVar21 = pshufhw(auVar22,auVar21,0x93);
