// Address: 0x1400e8d60
// Ghidra name: FUN_1400e8d60
// ============ 0x1400e8d60 FUN_1400e8d60 (size=200) ============


bool FUN_1400e8d60(longlong param_1,longlong param_2,int param_3)
...

{
  ...
  if ((*(longlong *)(param_1 + 0x10) == 0) ||
     ...
     (iVar4 = *(int *)(param_1 + 0xc0) - *(int *)plVar1, param_3 <= iVar4)) {

    if (*(ulonglong *)(param_1 + 0xc0) < (ulonglong)(lVar3 + *plVar1)) {
