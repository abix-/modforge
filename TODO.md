...
> Completed milestones live in [`docs/changelog.md`](docs/changelog.md).
> Per-subject deep dives live in [`docs/`](docs/).
...
[`docs/changelog.md`](docs/changelog.md) for context.
