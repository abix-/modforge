# `FUN_140094a20` @ 0x140094a20

**Size**: 13205 bytes
**Role**: `race_start_prompt` (string-anchored)
**Domain**: `race` - racing / betting / champion
**Pattern**: `struct_init` - Zero-initializes consecutive struct fields (constructor-like)
**Evidence**: zero-inits 9 fields

**Strings referenced**:
- `'On me! ha ha!'`
- `'Place your bets!'`
- `'None of these horses have ever raced before!'`
- `'These horses are hopeless!'`
- `'These horses are underdogs!'`
- `'This will be an exciting race!'`
- `'Congrats! Have another go'`
- `'These horses are all winners!'`
- `'Better luck with the next race'`
- `'Why not go on over to the paddock'`
- `'Minimum bet is now $%d, sir'`
- `'Your money is always welcome here'`
- `'Welcome back to the VIP lounge'`
- `'Minimum bet is now $%d'`
- `'Welcome To the VIP lounge. We have plants!'`
- `'Clapping'`
- `'StartNextRace'`
- `'TV Time Out %d'`
- `'flip win %d'`
...
**Game callers** (1): [`FUN_140094a20`](140094a20_FUN_140094a20.md)

**Game callees** (62): [`FUN_140007610`](140007610_FUN_140007610.md), [`FUN_14000f890`](14000f890_FUN_14000f890.md), [`FUN_140027900`](140027900_FUN_140027900.md), [`FUN_140027980`](140027980_FUN_140027980.md), [`FUN_1400279c0`](1400279c0_FUN_1400279c0.md), [`FUN_140027b00`](140027b00_FUN_140027b00.md), [`FUN_140027e30`](140027e30_FUN_140027e30.md), [`FUN_140027f50`](140027f50_FUN_140027f50.md), [`FUN_140028310`](140028310_FUN_140028310.md), [`FUN_1400285e0`](1400285e0_FUN_1400285e0.md)
  ... +52 more
