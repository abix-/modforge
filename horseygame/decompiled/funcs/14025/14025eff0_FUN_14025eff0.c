// Address: 0x14025eff0
// Ghidra name: FUN_14025eff0
// ============ 0x14025eff0 FUN_14025eff0 (size=1398) ============


void FUN_14025eff0(longlong param_1,int param_2,int param_3,int param_4,int param_5,
...

{
  ...
  if (param_3 == param_5) {
    ...
    if (param_4 < param_2) {
      ...
      puVar1 = (undefined2 *)(*(longlong *)(param_1 + 0x18) + (lVar7 + param_4) * 2);
      ...
      puVar12 = (undefined2 *)(*(longlong *)(param_1 + 0x18) + (lVar7 + lVar10) * 2);
    ...
    if (param_5 < param_3) {
      ...
      puVar12 = (undefined2 *)(*(longlong *)(param_1 + 0x18) + (iVar6 * param_5 + lVar10) * 2);
      ...
      puVar12 = (undefined2 *)(*(longlong *)(param_1 + 0x18) + (iVar6 * param_3 + lVar10) * 2);
    ...
    if (iVar11 == iVar14) {
      ...
      if (param_5 < param_3) {
        ...
        puVar12 = (undefined2 *)
                  ...
                  ((longlong)(iVar6 * param_5) + (longlong)param_4) * 2);
