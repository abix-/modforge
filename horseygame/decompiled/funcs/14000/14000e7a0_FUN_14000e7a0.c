// Address: 0x14000e7a0
// Ghidra name: FUN_14000e7a0
// ============ 0x14000e7a0 FUN_14000e7a0 (size=1868) ============


void FUN_14000e7a0(float *param_1,float *param_2,float param_3)
...

{
  ...
  if ((int)param_1[0x26] < 3) {
    ...
    FID_conflict__assert
              ...
              (L"m_vertexCount >= 3",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Collision\\Shapes\\b2PolygonShape.cpp",0x19c);
  ...
  if (lVar10 < 4) {
    ...
    if (lVar10 < 1) goto LAB_14000edfb;
    ...
    if (lVar10 <= lVar9) goto LAB_14000edfb;
  ...
  if (fVar43 <= fVar2) {
    ...
    FID_conflict__assert
              ...
              (L"area > 1.192092896e-07F",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Collision\\Shapes\\b2PolygonShape.cpp",0x1ca);
