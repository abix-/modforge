// Address: 0x14021ae70
// Ghidra name: thunk_FUN_140288540
// ============ 0x14021ae70 thunk_FUN_140288540 (size=5) ============


ulonglong thunk_FUN_140288540(longlong param_1,longlong param_2,undefined2 *param_3)
...

{
  ...
  cVar2 = FUN_1402889b0(0,&uStack_58);

  if (cVar2 == '\0') goto LAB_140288677;

  uVar3 = FUN_140287450(*(undefined8 *)(param_2 + 0x48),&uStack_58);

  plVar1 = *(longlong **)(*(longlong *)(param_2 + 0x48) + 0x50);

  iVar4 = (**(code **)(*plVar1 + 0x30))(plVar1,&uStack_58,uVar3);
...
LAB_140288677:
  ...
  uVar5 = FUN_140288830(&uStack_58,*param_3);
