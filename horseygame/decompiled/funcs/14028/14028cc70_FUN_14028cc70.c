// Address: 0x14028cc70
// Ghidra name: FUN_14028cc70
// ============ 0x14028cc70 FUN_14028cc70 (size=453) ============


void FUN_14028cc70(longlong param_1)
...

{
  ...
  iVar5 = (*(int *)(param_1 + 0x1c) - ((int)(iVar7 + 7 + (iVar7 + 7 >> 0x1f & 7U)) >> 3)) + iVar7;
      ...
      do {
        ...
        if (0 < iVar13) {
          ...
          do {
            ...
            uVar12 = (ulonglong)(byte)(bVar11 * '\x02');
