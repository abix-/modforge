// Address: 0x140190e30
// Ghidra name: FUN_140190e30
// ============ 0x140190e30 FUN_140190e30 (size=1199) ============


void FUN_140190e30(undefined1 *param_1,ulonglong param_2,ulonglong param_3,code *param_4,
...

{
  ...
  local_450 = param_1 + uVar4;

  if ((uVar7 <= uVar4) && (puVar9 = param_1 + (uVar4 / param_3 >> 1) * param_3, puVar9 < local_450))

  {
    ...
    do {
      ...
      if (param_3 * 0x28 < (ulonglong)((longlong)local_450 - (longlong)local_458)) {
        ...
        puVar9 = (undefined1 *)FUN_140190770(local_458,puVar9,local_450,param_3,param_4,param_5);
        ...
        puVar6 = local_458 + param_3;

        puVar5 = local_450 + -param_3;
      ...
      if ((ulonglong)((longlong)puVar5 - (longlong)local_458) < uVar7) {
        ...
        if (uVar4 < uVar7) {
          ...
          local_458 = (undefined1 *)*local_468;

          puVar5 = (undefined1 *)*local_460;
  ...
  puVar6 = param_1 + (uVar4 - 1) * param_3;
  ...
  while (puVar9 = puVar9 + param_3, puVar5 = puVar6, puVar9 != param_1 + param_2 * param_3) {
    ...
    if (puVar5 != puVar9) {
      ...
      FUN_1402f8e20(puVar5 + param_3,puVar5,(longlong)puVar9 - (longlong)puVar5);
