// Address: 0x1402edc48
// Ghidra name: FUN_1402edc48
// ============ 0x1402edc48 FUN_1402edc48 (size=1171) ============
...
DWORD * FUN_1402edc48(DWORD *param_1,uint param_2,byte *param_3,ulonglong param_4,longlong param_5)
...

{
  ...
  local_40 = DAT_1403e8b00 ^ (ulonglong)auStackY_108;
  ...
  local_70 = *(HANDLE *)((&DAT_1403ff160)[lVar18] + 0x28 + uVar7 * 0x48);
  ...
  if (local_98 < param_3 + (param_4 & 0xffffffff)) {
    ...
    do {
      ...
      if (local_9c == 0xfde9) {
        ...
        pcVar8 = (char *)(uVar7 * 0x48 + 0x3e + (&DAT_1403ff160)[local_68]);
        ...
        if ((longlong)uVar19 < 1) {
          ...
          if (lVar18 < iVar4) {
            ...
            if (0 < lVar18) {
              ...
              do {
                ...
                *(byte *)(uVar9 + uVar7 * 0x48 + 0x3e + (&DAT_1403ff160)[local_90]) = param_3[uVar9]
          ...
          lVar18 = FUN_1402f0444(&local_c4,&local_78,cVar3,&local_a8);
          ...
          cVar3 = (&DAT_1403e8ef0)[*(byte *)((&DAT_1403ff160)[lVar18] + 0x3e + uVar7 * 0x48)];
          ...
          if (lVar15 < lVar17) {
            ...
            if (0 < lVar15) {
              ...
              do {
                ...
                *(byte *)(uVar9 + uVar7 * 0x48 + 0x3e + (&DAT_1403ff160)[lVar18]) =
          ...
          puVar12 = (undefined1 *)(uVar7 * 0x48 + 0x3e + (&DAT_1403ff160)[local_68]);
          ...
          if (0 < lVar17) {
            ...
            FUN_1402f8e20(local_58 + uVar19,param_3,lVar17);

          }

          do {

            *(undefined1 *)(uVar9 + uVar7 * 0x48 + 0x3e + (&DAT_1403ff160)[lVar18]) = 0;
          ...
          lVar15 = FUN_1402f0444(&local_c4,&local_80,cVar3,&local_88);
          ...
          if (*(short *)(**(longlong **)(local_b0 + 0x18) + (ulonglong)*param_3 * 2) < 0) {
            ...
            if (local_b8 <= pbVar13) {
              ...
              *(byte *)(lVar15 + 0x3e + uVar7 * 0x48) = *param_3;
              ...
              pbVar13 = (byte *)((&DAT_1403ff160)[lVar18] + 0x3d + uVar7 * 0x48);
            ...
            iVar4 = FUN_1402eff44(&local_c4,param_3,2,local_b0);
        ...
        iVar4 = FUN_1402eff44(&local_c4,pbVar13,uVar16,local_b0);
...
LAB_1402edf50:
      ...
      uVar10 = FUN_1402f31e0(local_a0,0,&local_c4,cVar3);
