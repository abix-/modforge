// Address: 0x1402bf970
// Ghidra name: FUN_1402bf970
// ============ 0x1402bf970 FUN_1402bf970 (size=1187) ============


void FUN_1402bf970(longlong param_1)
      ...
      if ((int)uVar22 != 0) {
        ...
        do {
          ...
          if (((uVar1 & 0x50) != 0) && (uVar2 >> 0x18 < 0xff)) {
            ...
            uVar12 = (short)uVar14 * (ushort)bVar6 + 1;
...
LAB_1402bfb1e:
              ...
              uVar20 = ((ushort)((uVar12 >> 8) + uVar12) >> 8) + uVar16;
              ...
              uVar7 = ((ushort)((uVar12 >> 8) + uVar12) >> 8) + uVar14;
            ...
            else if (uVar13 == 0x40) goto LAB_1402bfb1e;

          }

          else if (uVar13 == 0x100) {

            uVar12 = (short)uVar16 * sVar3 + 1;
