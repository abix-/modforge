// Address: 0x1402d1e3c
// Ghidra name: FUN_1402d1e3c
// ============ 0x1402d1e3c FUN_1402d1e3c (size=692) ============


uint FUN_1402d1e3c(longlong param_1,longlong *param_2,uint param_3,byte param_4)
...
LAB_1402d1f8d:
  ...
  *param_2 = (longlong)(pcVar11 + -1);
  ...
  if ((cVar13 != '\0') && (pcVar11[-1] != cVar13)) {
    ...
    puVar7 = (undefined4 *)FUN_1402e68b0(uVar10,uVar12);
  ...
  if ((param_4 & 4) == 0) {
    ...
    if ((param_4 & 1) == 0) {
      ...
      if ((param_4 & 2) == 0) goto LAB_1402d20c1;
...
LAB_1402d20be:
    ...
    if ((param_4 & 2) == 0) {
      ...
      if (uVar14 < 0x80000000) goto LAB_1402d20c1;

    }

    else if (uVar14 < 0x80000001) goto LAB_1402d20be;
