// Address: 0x140202ca0
// Ghidra name: FUN_140202ca0
// ============ 0x140202ca0 FUN_140202ca0 (size=644) ============


void FUN_140202ca0(longlong param_1,longlong param_2,int *param_3,float *param_4)
  ...
  *param_4 = (float)bVar10;
  ...
  if (iVar4 < 0x3231564f) {
    ...
    if (iVar4 == 0x3231564e) {
      ...
      if (iVar4 != 0x3132564e) goto LAB_140202d9e;
...
LAB_140202d9e:
      ...
      if ((iVar4 + 0xe9e9e7fcU & 0xffbfffff) == 0) {
...
LAB_140202e17:
  ...
  if ((((fVar2 == DAT_140303398) || (fVar2 == DAT_14030339c)) || (fVar2 == DAT_14030374c)) ||
  ...
  if (*(longlong *)(param_1 + 0x1f0) == 0) {
    ...
    fVar2 = *(float *)(param_1 + 0x210);

  }

  else {

    fVar2 = *(float *)(*(longlong *)(param_1 + 0x1f0) + 0x20);

  }

  if ((fVar2 < (float)param_3[8]) && (0.0 < fVar2)) {

    param_4[8] = 2.0;

    fVar3 = (float)param_3[8];

    param_4[10] = fVar9 / fVar2;

    param_4[9] = fVar2 / (fVar3 * fVar3);

  }

  lVar6 = *(longlong *)(param_3 + 0x4e);

  if ((*(char *)(lVar6 + 0x40) != '\0') || (*(char *)(lVar6 + 0x58) != '\0')) {
