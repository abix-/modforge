// Address: 0x14001e4b0
// Ghidra name: FUN_14001e4b0
// ============ 0x14001e4b0 FUN_14001e4b0 (size=256) ============


undefined8 *

FUN_14001e4b0(longlong param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *puVar1 = b2EdgeAndCircleContact::vftable;
  ...
  if (*(int *)(*(longlong *)(param_1 + 0x18) + 8) != 1) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureA->GetType() == b2Shape::e_edge",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2EdgeAndCircleContact.cpp",0x29);
  ...
  if (*(int *)(*(longlong *)(puVar1[0xd] + 0x18) + 8) != 0) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureB->GetType() == b2Shape::e_circle",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2EdgeAndCircleContact.cpp",0x2a);
