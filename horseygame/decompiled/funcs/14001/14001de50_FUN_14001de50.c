// Address: 0x14001de50
// Ghidra name: FUN_14001de50
// ============ 0x14001de50 FUN_14001de50 (size=256) ============


undefined8 *

FUN_14001de50(longlong param_1,undefined8 param_2,longlong param_3,undefined8 param_4,
...

{
  ...
  *puVar1 = b2CircleContact::vftable;

  *(float *)((longlong)puVar1 + 0xc4) = fVar2;

  if (*(int *)(*(longlong *)(param_1 + 0x18) + 8) != 0) {

    FID_conflict__assert

              (L"m_fixtureA->GetType() == b2Shape::e_circle",

               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2CircleContact.cpp",0x2c);
  ...
  if (*(int *)(*(longlong *)(puVar1[0xd] + 0x18) + 8) != 0) {
    ...
    FID_conflict__assert
              ...
              (L"m_fixtureB->GetType() == b2Shape::e_circle",
               ...
               L"C:\\dev\\Box2d2\\Box2D\\Dynamics\\Contacts\\b2CircleContact.cpp",0x2d);
