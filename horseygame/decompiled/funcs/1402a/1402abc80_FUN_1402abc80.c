// Address: 0x1402abc80
// Ghidra name: FUN_1402abc80
// ============ 0x1402abc80 FUN_1402abc80 (size=1389) ============


void FUN_1402abc80(longlong param_1)
    ...
    if (iVar24 != 0) {
      ...
      do {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          uVar19 = (ushort)bVar1 * (ushort)(byte)(uVar6 >> 0x18) + 1;
          ...
          uVar19 = (ushort)bVar3 * (short)uVar25 + 1;
        ...
        if ((uVar5 & 2) != 0) {
          ...
          uVar19 = (ushort)bVar4 * (short)uVar17 + 1;
...
LAB_1402abea5:
            ...
            if (uVar26 == 0x10) {
              ...
              uVar21 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar18;

              uVar19 = sVar13 * sVar9 + 1;

              uVar22 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar16;

              uVar19 = sVar13 * sVar10 + 1;

              uVar15 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar25;

              uVar19 = sVar13 * (ushort)bVar11 + 1;

              uVar12 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar17;
            ...
            else if (uVar26 == 0x40) goto LAB_1402abea5;
        ...
        *puVar23 = ((uVar12 << 8 | uVar21) << 8 | uVar22) << 8 | uVar15;
