// Address: 0x1402a40c0
// Ghidra name: FUN_1402a40c0
// ============ 0x1402a40c0 FUN_1402a40c0 (size=1332) ============


void FUN_1402a40c0(longlong param_1)
...
LAB_1402a427c:
              ...
              if (uVar16 == 0x10) {
                ...
                uVar14 = ((ushort)((uVar12 >> 8) + uVar12) >> 8) + uVar21;

                uVar12 = sVar13 * sVar5 + 1;

                uVar23 = ((ushort)((uVar12 >> 8) + uVar12) >> 8) + uVar25;

                uVar12 = sVar13 * sVar6 + 1;

                uVar17 = ((ushort)((uVar12 >> 8) + uVar12) >> 8) + uVar15;
              ...
              else if (uVar16 == 0x40) goto LAB_1402a427c;
            ...
            uVar12 = (short)uVar21 * sVar4 + 1;

            uVar14 = (uint)((ushort)((uVar12 >> 8) + uVar12) >> 8);

            uVar12 = sVar5 * (short)uVar25 + 1;

            uVar23 = (uint)((ushort)((uVar12 >> 8) + uVar12) >> 8);

            uVar12 = sVar6 * (short)uVar15 + 1;
          ...
          *puVar24 = ((uVar8 << 8 | uVar17) << 8 | uVar23) << 8 | uVar14;
