// Address: 0x1402ac440
// Ghidra name: FUN_1402ac440
// ============ 0x1402ac440 FUN_1402ac440 (size=387) ============


void FUN_1402ac440(longlong param_1)
    ...
    if (iVar8 != 0) {
      ...
      if ((uVar4 & 1) == 0) {
        ...
        do {
          ...
          uVar9 = ((ushort)uVar6 & 0xff) * (ushort)bVar3 + 1;

          uVar10 = ((ushort)(uVar6 >> 8) & 0xff) * (ushort)bVar2 + 1;

          uVar11 = ((ushort)(uVar6 >> 0x10) & 0xff) * (ushort)bVar1 + 1;
