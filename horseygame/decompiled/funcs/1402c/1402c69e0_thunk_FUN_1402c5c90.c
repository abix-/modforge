// Address: 0x1402c69e0
// Ghidra name: thunk_FUN_1402c5c90
// ============ 0x1402c69e0 thunk_FUN_1402c5c90 (size=5) ============
...
thunk_FUN_1402c5c90(undefined1 (*param_1) [16],undefined1 (*param_2) [16],undefined1 (*param_3) [16]
...

{
  ...
  uStack_68 = DAT_1403e8b00 ^ (ulonglong)auStack_e8;
  ...
  if (param_4 != 0) {
    ...
    if (param_4 <= uVar13) {
      ...
      if (((DAT_1403e8ad4 >> 2 & 1) == 0) || (uVar13 < 0x10)) {
        ...
        FUN_1402f8e20(&pauStack_78,param_3,param_4);

        auVar17._8_8_ = uStack_70;

        auVar17._0_8_ = pauStack_78;

        pauVar7 = pauStack_c0 + -1;
        ...
        uVar5 = (uint)((ulonglong)pauStack_78 >> 0x20);
        ...
        if (pauVar7 != (undefined1 (*) [16])(puVar3 + uVar12)) {
          ...
          do {
            ...
            if (uVar10 != 0) {
              ...
              auStack_c8[0] = (uVar14 ^ 0xffff) & uVar10;
              ...
              if (auStack_c8[0] != 0) {
                ...
                do {
                  ...
                  if (auStack_c8[0] != 0) {
                    ...
                    for (; auStack_c8[0] >> uVar1 == 0; uVar1 = uVar1 - 1) {
                  ...
                  auVar16._0_4_ = *(uint *)*pauVar9 ^ (uint)pauStack_78;
                  ...
                  pbVar2 = (byte *)((longlong)auStack_c8 + ((longlong)(int)uVar1 >> 3));

                  *pbVar2 = *pbVar2 & ~('\x01' << (uVar1 & 7));

                } while (auStack_c8[0] != 0);
        ...
        if ((ulonglong)uVar12 != 0) {
          ...
          if (uVar12 != 0) {
            ...
            auStack_c8[0] = (uVar14 ^ 0xffff) & uVar12;
            ...
            if (auStack_c8[0] != 0) {
              ...
              do {
                ...
                if (auStack_c8[0] != 0) {
                  ...
                  for (; auStack_c8[0] >> uVar10 == 0; uVar10 = uVar10 - 1) {
                ...
                auVar15._0_4_ = *(uint *)*pauVar7 ^ (uint)pauStack_78;
                ...
                pbVar2 = (byte *)((longlong)auStack_c8 + ((longlong)(int)uVar10 >> 3));
        ...
        if ((auVar18 == (undefined1  [16])0x0) &&
           ...
           (pauStack_78 = param_2, iVar6 = memcmp(param_2 + 1,param_3,param_4 - 0x10),
        ...
        while (pauStack_78 = pauVar7, param_2 != (undefined1 (*) [16])(*param_1 + (uVar5 & 0xf))) {
          ...
          if (auVar15._0_4_ != 0) {
            ...
            do {
              ...
              if (auStack_c8[0] != 0) {
                ...
                for (; auStack_c8[0] >> uVar12 == 0; uVar12 = uVar12 - 1) {
              ...
              pbVar2 = (byte *)((longlong)auStack_c8 + ((longlong)(int)uVar12 >> 3));
        ...
        if (((uVar5 != 0) &&
            ...
            (auVar17 = pcmpestrm(auVar17,*pauStack_78,0xc),

            (auVar17._0_4_ & (1 << (sbyte)uVar5) - 1U) != 0)) &&

           (cVar4 = FUN_1402c6950(appauStack_a8), cVar4 != '\0')) {
