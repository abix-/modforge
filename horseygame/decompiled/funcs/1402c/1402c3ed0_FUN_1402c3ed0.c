// Address: 0x1402c3ed0
// Ghidra name: FUN_1402c3ed0
// ============ 0x1402c3ed0 FUN_1402c3ed0 (size=1400) ============


void FUN_1402c3ed0(longlong param_1)
    ...
    if (iVar24 != 0) {
      ...
      do {
        ...
        if ((uVar5 & 1) != 0) {
          ...
          uVar19 = (ushort)bVar3 * (ushort)(byte)(uVar6 >> 0x18) + 1;
...
LAB_1402c40f5:
            ...
            if (uVar26 == 0x10) {
              ...
              uVar21 = ((ushort)((uVar19 >> 8) + uVar19) >> 8) + uVar25;
            ...
            else if (uVar26 == 0x40) goto LAB_1402c40f5;
