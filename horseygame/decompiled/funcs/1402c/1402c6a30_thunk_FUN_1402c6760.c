// Address: 0x1402c6a30
// Ghidra name: thunk_FUN_1402c6760
// ============ 0x1402c6a30 thunk_FUN_1402c6760 (size=5) ============
...
thunk_FUN_1402c6760(undefined1 (*param_1) [16],undefined1 (*param_2) [16],undefined1 (*param_3) [16]
...

{
  ...
  uStack_48 = DAT_1403e8b00 ^ (ulonglong)auStack_78;
    ...
    if (param_4 == 1) {
      ...
      if (param_4 <= uVar4) {
        ...
        if (((DAT_1403e8ad4 >> 2 & 1) == 0) || (uVar4 < 0x10)) {
          ...
          FUN_1402f8e20(auStack_58,param_3,param_4);

          auVar1 = auStack_58;

          do {

            iVar3 = pcmpestri(auStack_58,*param_1,0xc);
          ...
          if ((longlong)param_2 - (longlong)param_1 != 0) {
            ...
            FUN_1402f8e20(auStack_58,param_1,(longlong)param_2 - (longlong)param_1);

            iVar3 = pcmpestri(auVar1,auStack_58,0xc);
