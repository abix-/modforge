...
| 1 | AI player follow | [x] Follow a named player through her AI controller's own path following | 2026-09-13 live: ai_player.follow re-requests MoveToActor every two seconds; she walked 232 units from the world start, then reported moving without progress at (-19042, 13550). What blocks her there (a door, a ledge) is unread |
| 1 | AI player walking blocked | [ ] Find what stops her at (-19042, 13550) after 232 units from the world start, and whether she can open doors | Read the path following state and the blocking actor; NPC door opening is CanOpenDoors on NPC_Base_ParentBP_C, a player opens doors by interaction; decide which she uses |
